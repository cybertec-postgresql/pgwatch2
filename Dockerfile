...
RUN wget -q -O grafana.deb https://dl.grafana.com/oss/release/grafana_6.4.4_amd64.deb \
...
RUN wget -q -O /tmp/go.tar.gz https://dl.google.com/go/go1.12.13.linux-amd64.tar.gz \
